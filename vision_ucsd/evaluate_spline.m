...
%
% Input:
% coefs: The B-spline coefficients defining the N splines
% ((L+3) x N matrix).  
...
%
% Output: 
% x: x-coordinate of the points s on the splines defined
...
% to find the x-coordinate of these points on the current
% pieces of the curves.  
%
% Functions called by this function:
% evaluate_spline_sigma
%
function [x,y] = evaluate_spline(coefs,s)
