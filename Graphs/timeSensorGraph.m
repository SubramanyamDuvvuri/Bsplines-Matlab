...
title ( 'Sensors vs Time Graph for noise = .08  using Binary rearch algorithm')
...
xlabel('Sensors')
ylabel('Time in seconds');
title ( 'Sensors vs Time Graph for noise = .08 using advanced algorithm ')
y= [3.68  10.14  29.86]
hold on
plot (x,y,'d-b','LineWidth',1.6 );
hold on
y= [3.08  12.1103  27.58]
plot (x,y,'d-r','LineWidth',1.6 );
axis([100 500 0 50 ])
