%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Date of completion of code : 26-Feb-2016
%Contains code to find optimised smoothing parameter using ordinary cross
%validation using hat matrix in two dimensions
...
for noisevec =1:length(noiseLevel_vec)
    ...
    for q = 1: length(nSensors)
        ...
        for knotnumber =1:length(knotsPerAxis)
            ...
            select_DataSet =2;
            lambda_grid=.4;
            lambda_start =.00001;                           %Setting the starting value of lambda
            lambda_end = 100;
            ...
            %--------------------------------------------------
            %Selection using Ordinary cross validation with Hat Matrix
            %-------------------------------------------------
            
             resolution_vec =[1:4];                             %Determines the resolution 
